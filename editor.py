...
class TextEditor:
    ...
    def __init__(self, root):
        ...
        # Window Details
        self.hello = tk.Label(text="TC IDE")
        self.hello.pack()
        #Main Text Box
    ...
    def save(self):
        ...
        try:
            ...
            messagebox.showerror(title="No extension",
                                 message="Automaticly Saving with .tc")
            extension = "tc"
        if (extension == "rbtf"):
            try:
                open(b, 'x')
    ...
    def about(self):
        messagebox.showerror(
            title="About",
            message=
            "TC IDE, based off of my text editor: https://github.com/Electro-Corp/Python-Text-Editor/, 0.10"
        )
